"""
train_model_concept_bottleneck_linear.py — Linear head on concept-bottleneck z.

Pairs with ``graph_concept_bottleneck_mlp_linear``. ``FRONTEND=cb_linear`` in sbatch.
"""
...
from model_concept_bottleneck_linear import ConceptBottleneckLinear
from model_v1 import GAT_LightningModule
...
def main():
    ...
    ap.add_argument("--hidden-dim", type=int, default=128, help="Unused; API parity.")
    ap.add_argument("--num-heads", type=int, default=None, help="Ignored.")
